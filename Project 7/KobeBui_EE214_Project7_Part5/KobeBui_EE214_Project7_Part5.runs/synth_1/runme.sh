...
HD_PWD='C:/Users/Kobe/Desktop/EE214_Projects/Project 7/KobeBui_EE214_Project7_Part5/KobeBui_EE214_Project7_Part5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log piso_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source piso_wrapper.tcl
