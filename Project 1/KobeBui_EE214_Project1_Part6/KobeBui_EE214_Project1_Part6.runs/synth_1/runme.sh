...
HD_PWD='C:/Users/Kobe/Desktop/EE214_Projects/KobeBui_EE214_Project1_Part6/KobeBui_EE214_Project1_Part6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_button.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb_button.tcl
