...
HD_PWD='C:/Users/Kobe/Desktop/EE214_Projects/Project 5/KobeBui_EE214_Project5_MUXDEMUX/KobeBui_EE214_Project5_MUXDEMUX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wrapper.tcl -notrace
