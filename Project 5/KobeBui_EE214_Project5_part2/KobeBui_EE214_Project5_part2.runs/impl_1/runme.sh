...
HD_PWD='C:/Users/Kobe/Desktop/EE214_Projects/Project 5/KobeBui_EE214_Project5_part2/KobeBui_EE214_Project5_part2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bin2seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bin2seg.tcl -notrace
