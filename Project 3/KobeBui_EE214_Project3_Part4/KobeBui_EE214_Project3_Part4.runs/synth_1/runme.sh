...
HD_PWD='C:/Users/Kobe/Desktop/EE214_Projects/Project/KobeBui_EE214_Project3_Part4/KobeBui_EE214_Project3_Part4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DashboardIndicator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DashboardIndicator.tcl
