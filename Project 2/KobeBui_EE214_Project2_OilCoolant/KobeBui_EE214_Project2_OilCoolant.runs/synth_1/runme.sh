...
HD_PWD='C:/Users/Kobe/Desktop/EE214_Projects/Project 2/KobeBui_EE214_Project2_OilCoolant/KobeBui_EE214_Project2_OilCoolant.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oilCoolant.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oilCoolant.tcl
